...
router.get("/city/:id", passportVerificator.authenticate( "jwt", {session: false} ), getCity)
router.get("/cities", passportVerificator.authenticate( "jwt", {session: false} ), getCities)
...
router.get("/itinerary/:id", passportVerificator.authenticate( "jwt", {session: false} ), getItinerary) //Get ONE itinerary from the DB by its ID
router.get("/itineraries", passportVerificator.authenticate( "jwt", {session: false} ), getItineraries) //Get all the itineraries from the DB
router.get("/itinerary", passportVerificator.authenticate( "jwt", {session: false} ), getItinerariesByCity) //Get all the itineraries of ONE city from the DB
